...
4. Which of the following may be examples of reversed cause and effect?
...
5. What can you do to determine if you are misinterpreting results because of a confounder?
...
6. Look again at the admissions data using ?admissions. What important characteristic of the table variables do you need to know to understand the calculations used in this video? Select the best answer.
...
7. In the example in the video, major selectivity confounds the relationship between UC Berkley admission rates and gender because:
...
8. Admission rates at UC Berkeley are an example of Simpson’s Paradox because:
